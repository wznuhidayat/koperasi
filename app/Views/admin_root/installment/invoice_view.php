                    ...
                    <div class="invoice p-3 mb-3">
                        ...
                        <div class="detail row">
                            ...
                            <div class="col-6 detail-right">
                                ...
                                <p>Jam &emsp;&emsp;&emsp;&emsp;&nbsp; : <?= date('H:m', strtotime($invoice['paid_at'])); ?> </p>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row no-print">
                            <div class="col-12">
                                <a href="/main/printinstallmentid/<?= $invoice['id_installment']; ?>" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                                <a href="/main/installment" class="btn btn-success float-right"><i class="far fa-check-circle"></i> Done</a>
